  ...
  en: {
    header: {
      ...
      categories: {
        ...
        drugstoreHealth: "Drugstore",
        beautyAndFragrance: "Beauty & Fragrance",
  ...
  ar: {
    header: {
      ...
      categories: {
        ...
        drugstoreHealth: "الصحة والعناية الشخصية",
        beautyAndFragrance: "الجمال والعطور",
        booksAndMedia: "الكتب والوسائط",
