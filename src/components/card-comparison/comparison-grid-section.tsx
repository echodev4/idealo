    ...
    return (
        <div>
            ...
            >
                ...
                {!open && needs && (
                    <div className="absolute bottom-0 h-8 w-full bg-gradient-to-t from-white to-transparent" />
                )}
            </div>
            {needs && (
                <button
        ...
        <div className="flex flex-col rounded-lg border bg-white">
            ...
            <div className="px-4 py-4 space-y-6">
                ...
                >
                    <ExpandableText
                        text={
                            card.welcomeBonus && card.welcomeBonus !== "-" ? card.welcomeBonus : undefined
                        }
                    />
                </AttributeRow>
