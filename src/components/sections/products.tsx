...
function ProductCell({ product, onOpenDetails }: { product: Product; onOpenDetails: () => void }) {
...
export default function Products({ products, landingPage }: { products: Product[]; landingPage?: boolean }) {
                    ...
                    <div className="grid grid-cols-2 gap-px sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {safeProducts.map((product, idx) => (
                            <div key={product._id ?? product.product_url ?? idx} className="bg-white">
                                <ProductCell product={product} onOpenDetails={() => openDetails(idx)} />
                            </div>
                        ))}
                    </div>
                </div>
